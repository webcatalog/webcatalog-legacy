...
const getTagNameAsync = () => Promise.resolve()
  .then(() => {
    ...
    if (allowPrerelease) {
      return Promise.resolve()
        .then(() => {
          ...
          const p = [
            customizedFetch('https://webcatalog.io/webcatalog-classic/juli/releases/latest.json')
              .then((res) => res.json())
              .then((data) => { stableVersion = data.version; }),
            customizedFetch('https://webcatalog.io/webcatalog-classic/juli/releases/prerelease.json')
              .then((res) => res.json())
    ...
    return customizedFetch('https://webcatalog.io/webcatalog-classic/juli/releases/latest.json')
      .then((res) => res.json())
