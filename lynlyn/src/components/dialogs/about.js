  ...
  return (
    ...
    >
      ...
      <DialogContent className={classes.dialogContent}>
        <img src={iconSvg} alt="LynLyn" className={classes.icon} />
        <Typography variant="title" className={classes.title}>LynLyn</Typography>
        <Typography
          variant="body1"
        ...
        <Typography variant="body1" className={classes.madeBy}>
          ...
          <span> by </span>
          <span
            onClick={() => requestOpenInBrowser('https://twitter.com/quanglam2807')}
            onKeyDown={() => requestOpenInBrowser('https://twitter.com/quanglam2807')}
            role="link"
            tabIndex="0"
