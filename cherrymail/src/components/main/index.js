...
const Main = ({
  ...
  <div className={classes.root}>
    <div className={classes.sidebarRoot}>
      <div className={classNames(classes.sidebarTop, isFullScreen && classes.sidebarTopFullScreen)}>
        ...
        {Object.keys(workspaces).length < 10 && (
          <WorkspaceSelector id="add" onClick={() => requestSetActiveWorkspace('home')} active={workspaces.home.active} />
        )}
      </div>
      {!navigationBar && (
