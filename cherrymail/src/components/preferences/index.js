  ...
  <div className={classes.root}>
    ...
    <Paper className={classes.paper}>
      <List dense>
        ...
        <Divider />
        <ListItem button onClick={() => requestOpenInBrowser('https://getcherrymail.com/privacy')}>
    ...
    <Paper className={classes.paper}>
      <List dense>
        {isDefaultMailClient ? (
          <ListItem>
            <ListItemText secondary="CherryMail is your default email client." />
          </ListItem>
        ) : (
          <ListItem>
            <ListItemText primary="Default email client" secondary="Make CherryMail the default email client." />
            <Button
              variant="outlined"
              size="small"
              color="default"
