...
export const fetchLatestTemplateVersionAsync = () => (dispatch, getState) => {
  ...
  return Promise.resolve()
    ...
    .then(() => {
      if (allowPrerelease) {
        return Promise.resolve()
          .then(() => {
            ...
            const p = [
              window.fetch('https://webcatalog.io/webcatalog-classic/juli/releases/latest.json')
                .then((res) => res.json())
                .then((data) => { stableVersion = data.version; }),
              window.fetch('https://webcatalog.io/webcatalog-classic/juli/releases/prerelease.json')
                .then((res) => res.json())
      ...
      return window.fetch('https://webcatalog.io/webcatalog-classic/juli/releases/latest.json')
        .then((res) => res.json())
