    ...
    <div className={classes.root}>
      <div className={classes.cardContainer}>
        <div className={classes.card}>
          ...
          <Button href="https://webcatalog.io/auth/sign-up?jwt=1&jwt_redirect_uri=https://dashboard.webcatalog.io">
            {STRING_CREATE_ACCOUNT}
          </Button>

          <Button href="https://webcatalog.io/auth/reset-password">
            {STRING_FORGOT_PASSWORD}
          </Button>
          ...
          <Button
            ...
            color="primary"
            href="https://webcatalog.io/auth/google?jwt=1&jwt_redirect_uri=https://dashboard.webcatalog.io"
            onClick={null}
            raised
          >
